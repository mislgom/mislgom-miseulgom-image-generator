...
## 🔧 v2.0.1 버그 수정 및 UI 개선 (2026-01-19)
...
- 🔌 **Stable Diffusion 연결 상태 표시**: 실시간 연결 상태 모니터링
  - 고급 설정 섹션에 연결 상태 인디케이터 추가
  - 3가지 상태 표시: 확인 중 (노란색), 연결됨 (초록색), 연결 안됨 (빨간색)
  - 재연결 버튼으로 수동 연결 확인 가능
  - localhost:7860 연결 상태 실시간 확인
